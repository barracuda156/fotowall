...
QColor QColorTriangleDialog::getColor(const QColor & initial, QWidget * parent, const QString & title, QColorDialog::ColorDialogOptions options)
{
    return QColorDialog::getColor(initial, parent, title, options);
}

QColor QColorTriangleDialog::getColor(const QColor & initial, QWidget * parent)
{
    return QColorDialog::getColor(initial, parent);
}

void QColorTriangleDialog::setCustomColor(int index, QRgb color)
{
    QColorDialog::setCustomColor(index, color);
}

void QColorTriangleDialog::setStandardColor(int index, QRgb color)
{
